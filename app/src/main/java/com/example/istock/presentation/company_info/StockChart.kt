package com.example.istock.presentation.company_info
...
import com.example.istock.util.colorToHex
...
fun StockChart(
    ...
    val textPaint = remember(density) {
        Paint().apply {
            color = android.graphics.Color.parseColor(colorToHex(scaleColor))
